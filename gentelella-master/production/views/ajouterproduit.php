<?php 
  ...
  if (isset($_POST['Ajouter'])) {
    $produit = new Produit($_POST['nom-p'], $_POST['prix-p'], $_POST['desc-p'], $_FILES['img-p']['name'], $_FILES['img-p']['tmp_name'], $_POST['qte-p'], $_POST['ref-p']);
        ...
        <h1>Ajouter le produit!</h1>
          <form method="post" enctype="multipart/form-data" name="ajoutproduit">
            <div class="form-group">
              ...
              <input type="text" name="ref-p" class="form-control" value="">
            </div>
            <div class="form-group">
              <label>Nom produit</label>
              <input type="text" name="nom-p" class="form-control" value="">
            </div>

            <div class="form-group">
              <label>Prix produit</label>
              <input type="number" name="prix-p" class="form-control" value="">
            </div>

            <div class="form-group">
              <label>Description produit</label>
              <input type="text" name="desc-p" class="form-control" value="">
            </div>

            <div class="form-group">
              <label>Quantite produit</label>
              <input type="number" name="qte-p" class="form-control" value="">
            </div>
            <div class="form-group">
              <label>Image</label>
              <input type="file" name="img-p" class="form-control">
            </div>
            <div class="form-group">
